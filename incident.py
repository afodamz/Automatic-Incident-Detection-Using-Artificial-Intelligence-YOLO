...
def main(_argv):
    ...
    TRAINING_IMAGES_DIR = './data/images/test'
    # TRAINING_IMAGES_DIR = os.getcwd() + './data/images/test'
    categories = os.listdir(TRAINING_IMAGES_DIR)

    for category in categories:
        path = os.path.join(TRAINING_IMAGES_DIR, category)
